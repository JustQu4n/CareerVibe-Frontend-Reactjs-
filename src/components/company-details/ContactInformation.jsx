  ...
  const contactItems = [
    {
      ...
      label: "Email",
      value: company.email || "Contact via website",
      color: "text-blue-600",
      bgColor: "bg-blue-100"
    },
    {
      ...
      label: "Phone",
      value: company.phone || "Contact via website",
 ...
 */
const ContactItem = React.memo(({ icon, label, value, color, bgColor, isLink }) => (
    ...
    <div className="flex-1 min-w-0">
      ...
      {isLink && value !== "Not provided" ? (
        <a 
          ...
          className={`${color} text-sm break-words hover:underline`}
        >
          {value}
        </a>
      ) : (
