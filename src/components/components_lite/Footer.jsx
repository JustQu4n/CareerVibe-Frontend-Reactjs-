      ...
      <div className="container mx-auto px-6 py-8">
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-6 md:mb-0">
            <Link to="/" className="flex items-center">
              <span className="text-2xl font-bold text-blue-600">CareerVibe</span>
            </Link>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="mt-4 space-y-2">
                <li><Link to="/jobs" className="text-gray-600 hover:text-blue-500">Browse Jobs</Link></li>
                <li><Link to="/companies" className="text-gray-600 hover:text-blue-500">Companies</Link></li>
                <li><Link to="/saved-jobs" className="text-gray-600 hover:text-blue-500">Saved Jobs</Link></li>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                <li><Link to="/post-job" className="text-gray-600 hover:text-blue-500">Post a Job</Link></li>
                <li><Link to="/admin/applications" className="text-gray-600 hover:text-blue-500">Manage Applications</Link></li>
                <li><Link to="/admin/company" className="text-gray-600 hover:text-blue-500">Company Profile</Link></li>
              </ul>
            </div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 text-center">
          <p className="text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} CareerVibe. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
