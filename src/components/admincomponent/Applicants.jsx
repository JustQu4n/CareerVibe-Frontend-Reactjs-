  ...
  const filteredApplications = applications
    .filter(app => {
      ...
      if (searchQuery) {
        ...
        const nameMatch = app.job_seeker_id?.full_name?.toLowerCase().includes(searchLower);
        const jobMatch = app.job_post_id?.title?.toLowerCase().includes(searchLower);
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
            ...
            <h2 className="text-xl font-bold text-red-700 mb-2">Error Loading Applications</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm p-5 border border-gray-100">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <h2 className="text-3xl font-bold text-gray-800">{stats.reviewed}</h2>
          ...
          <div className="bg-white rounded-xl shadow-sm p-5 border border-gray-100">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <h2 className="text-3xl font-bold text-gray-800">{stats.shortlisted}</h2>
          ...
          <div className="bg-white rounded-xl shadow-sm p-5 border border-gray-100">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <h2 className="text-3xl font-bold text-gray-800">{stats.rejected}</h2>
                    ...
                    <tr key={app._id} className="hover:bg-gray-50">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          <div className="h-10 w-10 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-semibold">
                            {app.job_seeker_id?.full_name?.charAt(0) || '?'}
                          </div>
                          <div className="ml-4">
                            ...
                            <div className="text-sm text-gray-500">
                              {app.job_seeker_id?.email || "No email provided"}
                            </div>
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">{app.job_post_id?.title || "Unknown Position"}</div>
                        <div className="text-xs text-gray-500">{app.job_post_id?.location || "No location"}</div>
                      </td>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div className="flex space-x-2">
                          <button className="text-blue-600 hover:text-blue-900" title="View Application">
                            <FaEye />
                          </button>
                          <a href={app.cv_url} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-900" title="View CV">
                            <FaFileAlt />
                          </a>
                          <button className="text-green-600 hover:text-green-900" title="Contact Applicant">
                            <FaEnvelope />
                          </button>
                        </div>
                      </td>
